...
define(function (require, exports, module) {
    ...
    //-------------FUNTION-----------------.
    //构造函数
    function teacherRecruitForm(th) {
        init();
    }

    function init() {
        require('./main').captcha(".teacherRecruitForms .captcha");
        $(".submitBtn").click(function () {
            ...
            } else if (teacherRecruitQQVal < 4 || teacherRecruitQQVal > 11 || isNaN($teacherRecruitQQ.val())) {
