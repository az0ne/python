	...
	var fieldValidTypeHand=function($field,status,options){
				if($field.prop("type")=="radio" || $field.prop("type")=="checkbox"){
					...
					if(status.required && status.pattern && status.conditional) {
						$field.parent("span").removeClass('field-invalid');
						$field.parent("p").removeClass('field-invalid');
						$field.parent(".textarea").removeClass('field-invalid');
					}else{
						$field.parent("span").addClass('field-invalid');
						$field.parent("p").addClass('field-invalid');
						$field.parent(".textarea").addClass('field-invalid');
					}
				}
	};
