var volumeDrag,inVolumeControl, VolumeControl, _isFull, videoHeaderDom, timeDrag, OFF1 = true;
...
$('.loading-video, .play-control').on('click', function (){
    var currentLesson = $('ul.video_part_lists li').index($('ul.video_part_lists li.liH')) + 1;
    if($thisUser == 'False'){
        login_popup('请先登录');
    }else{
        if(OFF1 == true){
