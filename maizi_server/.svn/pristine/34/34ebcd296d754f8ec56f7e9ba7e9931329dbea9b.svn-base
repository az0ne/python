...
function onQuery()
{
    ...
    window.location.href = "/student_assistant_monitor_learn_activity/?" + params ;

}

function onUpdateAssistant(phone)
{
    window.location.href = "/student_assistant_communication_all/?phone=" + phone;
}
