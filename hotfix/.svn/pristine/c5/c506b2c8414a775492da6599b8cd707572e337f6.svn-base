var th,xsize=120,ysize=120,boundx,boundy,wScale,hScale;
...
//初始化
var init = function(){
	var oClose = $('.zy_close'), oCuttPicture = $('#cuttPicture');
