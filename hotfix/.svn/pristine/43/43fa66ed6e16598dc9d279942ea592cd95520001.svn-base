...
class Configs(object):
    UC_KEY = settings.UC_KEY
    UC_API = settings.UC_API
    UC_CHARSET = settings.UC_CHARSET
    UC_IP = settings.UC_IP
    UC_APPID = settings.UC_APPID
    UC_PPP = settings.UC_PPP

    UC_CLIENT_VERSION = settings.UC_CLIENT_VERSION
    UC_CLIENT_RELEASE = settings.UC_CLIENT_RELEASE
