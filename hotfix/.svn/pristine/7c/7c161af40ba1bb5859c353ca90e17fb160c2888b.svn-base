...
from mz_platform.orms.mz_user.user import UserProfile
from mz_platform.orms.mz_user.django_permission import UserProfileGroups, AuthGroup

origin_class = [UserProfile, ]
