...
$.fn.extend({
		...
		　　}
			...
			/*参数定义*/
			defaults = {
				yearBegin: getNowYear()			//开始年(默认为:1960年)
				,yearEnd: 2024	//结束年(默认为:当前年)
			...
			$(this).each(function(){
				...
				//加入控件到文本框的位置
				selectYear.className = "form-control se-op";
				selectYear.name = "se_year";
				$("#date_year").append(selectYear);
				...
				//加入控件到文本框的位置
				selectMonth.className = "form-control se-op";
				selectMonth.name = "se_month";
				$("#date_month").append(selectMonth);
				/*END*/
				...
				//加入控件到文本框的位置
				selectDay.className = "form-control se-op";
				selectDay.name = "se_day";
				$("#date_day").append(selectDay);
